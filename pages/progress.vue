      ...
      <div class="bg-white rounded-xl border border-slate-200 p-5 mb-6">
        <div class="flex flex-col sm:flex-row gap-3">
          <div class="flex-1">
            ...
            <select id="progress-level" v-model="filterLevel" @change="loadStudents" class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm">
          ...
          <div class="flex-1">
            ...
            <select id="progress-student" v-model="selectedStudentId" class="w-full px-3 py-2 border border-slate-200 rounded-lg text-sm">
